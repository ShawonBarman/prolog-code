...
symptom(Patient, pale_or_yellowish_skin) :-
    write_list(['Does ',Patient,' have a pale_or_yellowish_skin (y/n) ?']),
    response(Reply),
    Reply='y'.

symptom(Patient, facial_bone_deformities) :-
    write_list(['Does ',Patient,' have a facial_bone_deformities (y/n) ?']),
    response(Reply),
    Reply='y'.
...
symptom(Patient, inflammation) :-
    write_list(['Does ',Patient,' have a inflammation (y/n) ?']),
    response(Reply),
    Reply='y'.
